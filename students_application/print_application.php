...
<script type="text/javascript">
	...
	<div id="basic_details_form">
		<center><h1>Print Application</h1></center>
	</div>
	...
	<table>
		...
		<tr>
			...
			<td><label><?php echo($row['application_fee']);  ?></label></td>
		</tr>
		<tr>
			<td><span>Application Payment :</span></td>
			<td><label><?php echo($row['application_payment']);  ?></label></td>
		</tr>
