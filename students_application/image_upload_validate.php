...
if($selected_admission==NULL)
{
	...
	$file_name=$_FILES["candidates_photo"]["name"];
	$tmp_name=$_FILES["candidates_photo"]["tmp_name"];
	$folder="candidates_photo/".$application_id;
if(move_uploaded_file($tmp_name,$folder)){
	echo"<script>confirm('candidates photo saved');window.location.href='image_upload.php'</script>";
	}
	else
	{
