	...
	<form method="post" action="#">
		...
		<div id="form_right">
			...
			<tr>
				...
				<td><input type="Password" name="re_password" onfocus="validate_password()" id="re_password" minlength="8" placeholder="Enter Chair-person Name"  required></td>
			</tr>
		</table>
		</div>
		<div id="photo">
		...
		<input type="checkbox" name="" required id="check_box">
	</form>
</div>
