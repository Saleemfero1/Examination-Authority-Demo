...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/new_collage_form.css">
</head>
...
<div id="application">
	<form method="post" action="new_collage_form_validate.php" enctype="multipart/form-data">
		<table id="1">
			<tr>
		...
		<div id="form_right">
			...
			<tr>
				...
				<td><input type="radio" id="name" name="collage_type" value="1" placeholder="Enter collage name here" required><label>Government</label>
				<input type="radio" id="name" name="collage_type" value="2" placeholder="Enter collage name here"><label>Private</label></td>
			</tr>
			<tr>
