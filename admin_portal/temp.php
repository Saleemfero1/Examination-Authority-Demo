		...
		<div id="form_right">
			...
			<tr>
				...
				<td><input type="Password" name="Password" 
					minlength="8" title="must contain atleast 8 or more characters" 
				 placeholder="Enter Chair-person Name "required></td>
			</tr>
			<tr>
				<td><span>Re-Enter Password :</span></td>
				<td><input type="Password" name="re-password" minlength="8" placeholder="Enter Chair-person Name "  required></td>
			</tr>
		</table>
		</div>
		<div id="photo">
